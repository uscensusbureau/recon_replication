...
def check_magic(filepath: str, magic) -> bool:
...
def valid_convertable_document_file(fname: str) -> bool:
...
def convert_document_to_pdf(infile: str, TopMargin=None, BottomMargin=None) -> str:
