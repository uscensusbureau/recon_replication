...
def create_tag(*, resourceId: str, key_value_pairs: Dict) -> None:
...
def delete_tag(*, resourceId: str, tags: List) -> None:
...
def describe_instances(*, groupid: str = None):
...
def get_instance_tags(instanceId: str = None) -> Dict:
