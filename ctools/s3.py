...
def s3_object(bucket: str, key: str):
...
def getsize(bucket: str, key: str) -> int:
    return s3_resource().Object(bucket,key).content_length


def put_object(bucket: str, key: str, fname: str, use_acl: bool = False):
...
def list_objects(bucket: str, prefix: str = None, limit: int = None, delimiter: str = None):
...
def search_objects(bucket: str, prefix: str = None, *, name: str, delimiter: str = '/', limit: int =None,
                   searchFoundPrefixes: bool = True, threads: int = 20, callback = None) -> List:
...
def download_object(tempdir: str, bucket: str, obj) -> None:
...
class S3File:
    ...
    def __init__(self, name: str, mode: str = 'rb') -> None:
        self.name = name
    ...
    def _readrange(self, start: int, length: int) -> bytes:
...
class s3open:
    ...
    def waitObjectExists(self) -> None:
