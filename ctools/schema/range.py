...
def convertRange(a,b, desc: str = None, vtype=None):
    try:
...
class Range:
    ...
    @staticmethod
    def extract_range_and_desc(possible_legal_value: str, python_type=str, hardfail: bool = False, width: int = None):
    ...
    def __init__(self,a=None,b=None, desc: str = None, *, attrib: Dict = {}) -> None:
    ...
    def python_expr(self, python_type: type, width: int) -> str:
