...
class Table:
    ...
    def __init__(self, *, name: str, desc: str = None, attrib: Dict = {}, csv_file=None,csv_writer=None, delimiter: str = None) -> None:
    ...
    @classmethod
    def FromDict(self, name: str, dict: Dict = {}):
    ...
    def python_class(self, ignore_vars: List[str] = []) -> str:
    ...
    def sql_schema(self, extra: Dict = {}) -> str:
    ...
    def sql_insert(self, dialect: str = MYSQL, extra: Dict = {}) -> None:
    ...
    def write_sql_scanner(self, f) -> None:
    ...
    def open_csv(self, fname: str, delimiter: str = ',', extra: List[str] = [], mode: str = 'w', write_header: bool = True) -> None:
        import csv
    ...
    def parse_line_to_row(self, line: str, delimiter: str = None) -> List:
    ...
    def parse_line_to_dict(self, line: str, delimiter: str = None) -> Dict:
    ...
    def parse_and_write_line(self, line: str, extra: List[str] = []) -> None:
        self.write_row(self.parse_line_to_row(line), extra=extra)

    def parse_line_to_SparkSQLRow(self, line: str):
    ...
    def unparse_dict_to_line(self, d: Dict, delimiter: str = ',') -> str:
        return delimiter.join([v.vformat(self.overrides.get(v.name,d[v.name])) for v in self.vars()])

    def write_dict(self, d: Dict) -> None:
    ...
    def extract_variable_from_line(self, varname: str, line):
        v = self.vardict[varname]
        return line[ v.column[0]: v.column[1]+1]

    def write_row(self, row, extra: List[str] = []) -> None:
