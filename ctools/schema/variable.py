...
class Variable:
    ...
    def __init__(self, *, name: str = None, vtype: str = None, python_type = None, desc: str = "",
                 position=None, column: int = None, width: int = None, default=None,
                 format: str = schema.DEFAULT_VARIABLE_FORMAT, attrib: Dict = {}, prefix: str = "",
                 allow_whitespace: bool = False,start=None,end=None, allow_null: bool = False, allow_any: bool = False) -> None:
        ...
        if self.position is None and self.column is not None:
    ...
    def set_vtype(self, vtype: str = None, python_type = None) -> None:
    ...
    def add_range(self, newrange: Range) -> None:
    ...
    def add_valid_data_description(self, desc: str) -> None:
    ...
    def set_allow_whitespace(self) -> None:
    ...
    def random_value(self):
        ...
        if "f" in self.format:   # special case for floating points that specify a range
            ...
            random_range = random.choice(list(self.ranges))
