...
class Schema:
    ...
    def __init__(self, name: str = '', *, debug: bool = False, attrib: Dict = {}) -> None:
        self.debug     = debug
    ...
    def has_code_snippet(self, name: str) -> bool:
        return name in self.code_snippets

    def add_code_snippet(self, code_snippet: CodeSnippet) -> CodeSnippet:
    ...
    def del_code_snippet_named(self, name: str) -> None:
        del self.code_snippets[name]
        logging.info("Deleted code snippet {}".format(name))

    def add_code_snippet_named(self, *, name: str, **kwargs) -> CodeSnippet:
        return self.add_code_snippet( CodeSnippet(name=name, **kwargs) )

    def get_code_snippet(self, name: str, create: bool = False) -> CodeSnippet:
        """
    ...
    def del_table_named(self, name: str) -> None:
        del self.tabledict[name]
        logging.info("Deleted table {}".format(name))

    def add_table_named(self, *, name: str, **kwargs) -> Table:
        return self.add_table( Table(name=name, **kwargs) )

    def get_table(self, name: str, create: bool = False) -> Table:
    ...
    ### SQL Support
    ################################################################
    def add_sql_table(self, stmt: str) -> None:
    ...
    ### Pandas support
    ################################################################
    def get_pandas_file_reader(self, filename: str, chunksize: int = schema.PANDAS_CHUNKSIZE) -> pd.DataFrame:
    ...
    ################################################################
    def load_schema_from_file(self, filename: str) -> None:
    ...
    ################################################################
    def read_records_as_dicts(self, *, filename: str = None, tablename: str, limit: int = None, random: bool = False) -> None:
    ...
    def recode_names(self) -> List[str]:
        """Return an array of all the recode names"""
        return [r.name for r in self.recodes.values()]

    def add_recode(self, name: str, vtype: str, desc: str) -> None:
    ...
    def recode_load_data(self, tablename: str, data) -> None:
        self.recode_module.__dict__[tablename] = data

    def recode_execute(self, tablename: str, data) -> None:
    ...
    ### Overrides
    ################################################################
    def create_overrides(self, keyword: str) -> None:
    ...
    ### Defaults
    def find_default_from_allowable_range_descriptions(self, text: str) -> None:
