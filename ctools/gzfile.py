...
class GZFile:
    def __init__(self, name: str, mode: str = 'r', level: int = 6, buffering=-1, encoding: str = None, errors=None,
                 newline=None, closefd=True, opener=None, auto: bool = False) -> None:
    ...
    def __exit__(self, err, msg: str, stack):
        if err:
            raise err
        self.close()
