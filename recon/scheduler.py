...
#
"""scheduler.py:
The two time-consuming parts of the reconstruction are building and solving the
LP files. This schedules the jobs on multiple machines using a MySQL database
for coordination.

This is a simple scheduler for a single system. But you can run it on multiple
systems at the same time. They coordinate through the database
